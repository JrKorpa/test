...
function getNew(){
	...
	$sql = "select ss.style_id,si.style_sn,stone_cat as sec_stone_cat,ss.stone_attr as sec_stone_attr from `test`.`rel_style_stone` as ss,`test`.`base_style_info` as si where ss.style_id=si.style_id and stone_position=2 and stone_cat<>0 and is_new=0;";
	$arr = mysqli_query($db_new, $sql);
	$data= array();
