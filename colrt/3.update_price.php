 ...
 * @Last Modified time: 2015-10-29 11:11:24
 */
...
$sql = "select * from `base_style_info` `s` inner join `list_style_goods` `x` on `s`.`style_sn` = `x`.`style_sn` where `s`.`style_type` not in(2,10,11) and `x`.`shoucun` = '0';";
