...
$sql = "select goods_id,TIMESTAMPDIFF(DAY,change_time,if(chuku_time,chuku_time,now())) as 'thisage',TIMESTAMPDIFF(DAY, addtime,if(chuku_time,chuku_time,now()))  as 'allage' from `warehouse_goods`";
...
$sql = "select * from `list_style_goods` where style_sn in() order by style_id desc;";
