 ...
 * @Last Modified time: 2015-10-12 11:47:39
 */
...
$sql = "select * from `list_style_goods` where style_sn in('W9971','W7443','W5731','KLRX010562','KLRW029026','B9446','KLRM028916','A1023','KLRX014759') and goods_sn in ('B9446-PT950-W-0-15') order by style_id desc;";
...
//print_r($xiangkou);die;
    ...
    //9,计算定制成本价格
    echo 'fushi_price_1 '."<br>";
    echo 'fushi_price_2 '."<br>";
    echo 'fushi_price_3'."<br>";
    echo 'tal_jinsun '."<br>";
    echo 'tal_gongfei'."<br>";
