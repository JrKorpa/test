 ...
 * @Last Modified time: 2017-03-13 20:06:57
 */
...
$sql = "select * from `base_style_info` `s` inner join `list_style_goods` `x` on `s`.`style_sn` = `x`.`style_sn` where `s`.style_sn in('KLDW027054',
'KLPW024276',
'KLPW027055')";
